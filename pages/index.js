...
export default function Home() {
    ...
    const appStoreLink = "https://apps.apple.com/app/kophecy/id6443527758";
    const playStoreLink = "https://play.google.com/store/apps/details?id=com.deventhusiast.kophecy";
    return (
        <>
                ...
                <div className="relative container px-4 mx-auto">
                    <div className="flex flex-wrap items-center -mx-4">
                        <div className="w-full md:w-3/5 px-4 mb-16 md:mb-0">
                            <h2 className="mb-10 text-3xl md:text-4xl font-semibold font-heading">The best Ellen G.
                                White quotes</h2>
                            <div className="max-w-xl">
                                <p className="mb-10 text-xl text-gray-500">Kophecy is a mobile app that provides you
                                    with the best available quotes of Ellen G. White writings (Spirit of Prophecy)</p>
                            </div>
                        ...
                        <div className="max-w-md lg:mx-auto">
                            ...
                            <div className="flex items-start mb-10">
                                ...
                                <div className="max-w-sm">
                                    <h3 className="mb-6 text-2xl font-semibold font-heading">Inspirational quotes</h3>
                                    <p className="text-xl text-gray-500">Browse, share, thousands of inspirational
                                        quotes from great books</p>
                                </div>
                            </div>
                            <div className="flex items-start mb-10">
                                <div className="mt-2 mr-4">
                                ...
                                <div className="max-w-sm">
                                    ...
                                    <p className="text-xl text-gray-500">Search among our numerous quotes and save your
                                        favorite ones </p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                ...
                                <div className="max-w-sm">
                                    <h3 className="mb-6 text-2xl font-semibold font-heading">Save & Share</h3>
                                    <p className="text-xl text-gray-500">
                                        Save and share your favorite quotes with your family, friends...
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap items-center -mx-4">
                        ...
                        <div className="w-full md:w-3/5 px-4">
                            <div className="max-w-max ml-auto">
                                <h2 className="mb-10 text-3xl md:text-4xl font-semibold font-heading">Kophecy</h2>
                                <div className="max-w-xl mb-5 md:mb-10">
                                    <p className="text-xl text-gray-500">Inspirational quotes for your christian
                                        walk</p>
                                </div>
                                <div className="flex justify-start items-center">
                                    <a className="mr-4" href={appStoreLink} target="_blank">
